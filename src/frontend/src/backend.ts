...
import type { PartyMasterRecord as _PartyMasterRecord } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async importPartyMasters(arg0: Array<[string, PartyMasterRecord]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.importPartyMasters(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PartyMasterRecord]): PartyMasterRecord | null {
